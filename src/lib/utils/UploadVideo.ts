...
export default function UploadVideo(file: File, callback) {
    try {
        ...
        $.ajax(`https://api.cloudinary.com/v1_1/${REACT_APP_PUBLIC_CLOUDINARY_CLOUD_NAME}/video/upload`, {
            "url": `https://api.cloudinary.com/v1_1/${REACT_APP_PUBLIC_CLOUDINARY_CLOUD_NAME}/video/upload`,
            "method": "POST",
            "timeout": 0,
            "processData": false,
